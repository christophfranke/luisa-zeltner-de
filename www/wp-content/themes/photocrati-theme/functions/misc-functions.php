  ...
  ?>
    ...
    <div class="comment-wrapper">
        ...
        <div class="content-wrapper">
            <div class="comment-meta"><?php printf(__('Posted %1$s at %2$s by <a href="%4$s" title="Comment Author" target="_blank">%3$s</a> <span class="meta-sep">|</span> <a href="%5$s" title="Permalink to this comment">Permalink</a>', 'photocrati-framework'),
                        get_comment_date(),
                        get_comment_time(),
                        get_comment_author(),
